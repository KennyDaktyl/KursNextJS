			...
			fields: [
				{
					...
					type: {
						kind: "NamedType",
						name: { kind: "Name", value: "Product", loc: { start: 40, end: 47 } },
						loc: { start: 40, end: 47 },
					},
					directives: [],
					loc: { start: 22, end: 47 },
			...
			fields: [
				...
				},
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "String", loc: { start: 84, end: 90 } },
							loc: { start: 84, end: 90 },
						},
						loc: { start: 84, end: 91 },
					},
				...
				},
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "String", loc: { start: 100, end: 106 } },
				...
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "description", loc: { start: 110, end: 121 } },
					arguments: [],
					type: {
						kind: "NonNullType",
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "String", loc: { start: 123, end: 129 } },
				...
				},
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "Int", loc: { start: 140, end: 143 } },
