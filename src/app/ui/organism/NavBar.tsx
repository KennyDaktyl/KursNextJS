...
export async function NavBar() {
    ...
    return (
        <div className="bg-white md:flex justify-center sticky top-0 dark:bg-gray-700 z-50">
            <div className="mobile-nav bg-white text-dark overflow-x-auto dark:bg-gray-700 dark:text-white">
